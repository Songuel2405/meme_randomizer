...
CATEGORIES = {
    "Tiere": 
    {"Hunde": get_resource_path("memes\Tiere\Hunde"),
     "Katzen": get_resource_path("memes\Tiere\Katzen"),
     "Hund+Katze": get_resource_path("memes\Tiere\Hund+Katze"),
     "Katze+Maus": get_resource_path("memes\Tiere\Katze+Maus"),
     "Elefant": get_resource_path("memes\Tiere\Elefant"),
     "Maus": get_resource_path("memes\Tiere\Maus"),
     "Wildtiere": get_resource_path("memes\Tiere\Wildtiere"),
     "Vögel": get_resource_path("memes\Tiere\Vögel")},
     "Emotionen": 
     {"Glücklich": get_resource_path("memes\Emotionen\Glücklich"),
      "Traurig": get_resource_path("memes\Emotionen\Traurig"),
      "Verwirrt": get_resource_path("memes\Emotionen\Verwirrt")},
    "Gaming": get_resource_path("memes\Gaming"),
    "IT": get_resource_path("memes\IT"),
    "Deutsch": get_resource_path("memes\Deutsch"),
    "Kochen": get_resource_path("memes\Kochen"),
    "Musik": get_resource_path("memes\Musik")}
